...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .admin-footer { text-align: center; padding: 24px 16px 32px; margin-top: 32px; display: flex; flex-direction: column; align-items: center; gap: 4px; }
    .admin-footer .footer-powered { font-size: 0.62rem; font-weight: 500; text-transform: uppercase; letter-spacing: 0.08em; color: #999; }
    .admin-footer .footer-logo { height: 18px; width: auto; opacity: 0.4; }
    .admin-footer .footer-text { font-size: 0.65rem; color: #aaa; margin-top: 2px; }
  </style>
</head>
<body>
  <header>
    ...
    <div class="card">
      ...
      <div class="file-input-wrap" id="csv-drop-zone">
        <label class="file-label" for="csv-file">
          ...
          <div class="file-text">Tap to select multiple CSV files, or drag & drop here</div>
          <div class="file-name" id="csv-file-name">No files selected</div>
        </label>
        <input type="file" id="csv-file" accept=".csv,text/csv" multiple onchange="handleFileSelect(this, 'csv-file-name', 'upload-csv-btn')">
      </div>
  ...
  <footer class="admin-footer">
    ...
    <img src="/logos/yunex_logo_gradient.svg" alt="Yunex Traffic" class="footer-logo">
    <p class="footer-text">© Yunex Traffic</p>
  </footer>
  ...
  <script>
    ...
    async function uploadCSV() {
      ...
      try {
        ...
        fileInput.value = '';
        handleFileSelect(fileInput, 'csv-file-name', 'upload-csv-btn');
      }
    }
